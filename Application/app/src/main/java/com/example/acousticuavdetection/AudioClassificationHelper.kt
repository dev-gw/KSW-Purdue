...
class AudioClassificationHelper(
    ...
    private lateinit var inputFeatureBuffer: TensorBufferFloat
    val mfccFeatures: Array<Float>? = loadMfccFeatures()
    ...
    fun initClassifier() {
        ...
        try {
            ...
            inputFeatureBuffer =
                TensorBufferFloat.createFixedSize(intArrayOf(1, mfccFeatures!!.size, mfccFeatures[0].size), DataType.FLOAT32) as TensorBufferFloat
            inputFeatureBuffer.loadArray(mfccFeatures)
    ...
    fun loadMfccFeatures(mfccFeatures: <FloatArray>): <FloatArray>? {
        return mfccFeatures
    }
    companion object {
        ...
        const val UAV_MODEL = "uav.tflite"
    }
}
